...
namespace Bloxstrap
{
    ...
    {
        public const string ProjectDisplayName = "BYTEBLOX";

#if QA_BUILD
        public const string ProjectName = "ByteBlox-QA";
#else
        public const string ProjectName = "ByteBlox";
#endif
        public const string ProjectOwner = "ByteSecDevelopment";
        public const string ProjectRepository = $"{ProjectOwner}/ByteBlox";
        public const string ProjectDownloadLink = $"https://github.com/{ProjectRepository}/releases";
        public const string ProjectHelpLink = $"https://github.com/{ProjectRepository}/wiki";
        public const string ProjectSupportLink = $"https://github.com/{ProjectRepository}/issues/new";
        public const string ProjectRemoteDataLink = "https://config.bytesec.app/v1/Data.json";
        ...
        private static void MigrateLegacyCleanerSettings()
        {
            var dirs = Settings.Prop.CleanerDirectories;
            for (int i = 0; i < dirs.Count; i++)
            {
                if (dirs[i] == "FishstrapLogs")
                    dirs[i] = "ByteBloxLogs";
                else if (dirs[i] == "FishstrapCache")
                    dirs[i] = "ByteBloxCache";
            }
        }
