...
namespace Bloxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconByteBloxClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconByteBlox;
            }

            return icon switch
            {
                //BootstrapperIcon.IconFishstrap => Properties.Resources.IconFishstrap,
                BootstrapperIcon.IconByteBlox => Properties.Resources.IconByteBlox,
                ...
                BootstrapperIcon.IconByteBloxClassic => Properties.Resources.IconByteBloxClassic,
                _ => Properties.Resources.IconByteBlox
            };
        }
    }
}
