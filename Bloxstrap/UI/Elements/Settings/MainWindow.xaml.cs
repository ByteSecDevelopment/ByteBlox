...
namespace Bloxstrap.UI.Elements.Settings
{
    ...
    public partial class MainWindow : INavigationWindow
    {
        ...
        public void RefreshAmbientBackground() => AmbientBackdrop.ApplyMode();
        ...
        {
            if (App.LaunchSettings.TestModeFlag.Active || App.LaunchSettings.PlayerFlag.Active)
