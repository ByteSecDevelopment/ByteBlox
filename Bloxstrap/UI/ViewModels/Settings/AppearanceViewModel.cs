...
namespace Bloxstrap.UI.ViewModels.Settings
{
    public class AppearanceViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool UiPerformanceMode
        {
            get => App.Settings.Prop.UiPerformanceMode;
            set
            {
                App.Settings.Prop.UiPerformanceMode = value;
                OnPropertyChanged(nameof(UiPerformanceMode));
                if (Window.GetWindow(_page) is MainWindow main)
                    main.RefreshAmbientBackground();
                App.Settings.Save();
            }
        }
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconByteBlox;
                }
                else
                {
